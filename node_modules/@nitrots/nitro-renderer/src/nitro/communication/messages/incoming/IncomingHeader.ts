export class IncomingHeader {
    ...
    public static USER_STATS = 4001;
    public static INVENTORY_ITEMS = 4002;
    public static ZeusStats = 4005;
    public static InspectUserStatsComposer = 4009;
    public static GangStatusComposer = 4011;
    public static PoliceCallEvent = 4013;
    public static SendLiveFeed = 4014;
    public static GatherProgressComposer = 4016;
    public static OpenSellModuleEvent = 4017;
    public static CancelGatherComposer = 4019;
    public static ItemOfferPopupComposer = 4021;
    public static GangInvitePopupComposer = 4023;
    public static GangMembersEvent = 4025;
    public static GangRanksEvent = 4027;
    public static UpdateWorkStatus = 4031;
    public static WantedList = 4032;
    public static GetCorporationsEvent = 4033;
    public static VirtualRoomInfoEvent = 4034;
    public static InventoryUpdateEvent = 4035;
    public static ColorPalette = 4037;
    public static GetCorporationMembersEvent = 4039;
    public static CorporationRanksEvent = 4040;
    public static BlackjackModuleEvent = 4041;

    public static BlackjackStateEvent = 4042; // starts game
    //public static BlackJackMessage = 4043; // Sends message
    public static MarketPlaceEvent = 4044;
    public static TimeOfDayEvent = 4045;
    public static HighLowModuleComposer = 4046;
    public static HighLowStateComposer = 4047;
    public static SlotMachineModuleEvent = 4048;
    public static SlotMachineStateEvent = 4049;
    public static WheelStateEvent = 4050;
    public static WheelModuleEvent = 4051;
    public static HotelAlertEvent = 4052;
    public static QuickGuideEvent = 4053;
    public static HeightMapUpdateEvent = 4054;

    public static TurfCaptureProgressEvent = 4056;

    public static TaxiRequestEvent = 4057;

    public static JukeboxStateEvent = 4058;
    public static JukeboxToastEvent = 4059;
    public static ChatBubbleShopEvent = 4060;
    public static ChatBubblePurchaseOkEvent = 4061;

    public static NameIconShopEvent = 4062;
    public static NameIconPurchaseEvent = 4063;

    public static OpenFishingModuleEvent = 4064;
    public static OpponentStatsEvent = 4066;

    public static ClickThroughStateEvent = 4067;

    // Token

    public static TokensStoreEvent = 4068;
    public static TokenPurchaseOkEvent = 4069;
    public static OpenATMEvent = 4070;
    public static BulkRemoveFloorItemsEvent = 4071;
    public static BulkAddFloorItemsEvent = 4072;

    public static CommandsListEvent = 4073;

    // Arena

    public static ArenaStatusMessageEvent = 4075;

    public static DoorDashOrdersEvent = 4076;

    public static ProfileAchievementsEvent = 4077;

    public static OpenAvatarEditorEvent = 4078;

    public static HotRoomsListEvent = 4079;

    public static OpenCorpJobBoardEvent = 4080;

    public static JukeboxOpenEvent = 4081;
    public static ArenaLeaderboardEvent = 4082;
    public static CasinoJackpotUpdateEvent = 4083;
    public static RoleplayCombatCooldownEvent= 4084;
    public static HeistTimerEvent = 4085;
    public static HeistTimerStopEvent = 4086;


    // Trading


    public static TradeOpenEvent = 4087;
    public static TradeUpdatedEvent = 4088;
    public static TradeResultEvent = 4089;
    public static TradeCloseEvent = 4090;


    // Mythical Weapons

    public static MythicalBlueprintOpenEvent = 4091;
    public static MythicalBlueprintUpdateEvent = 4092;
    public static MythicalBlueprintResultEvent = 4093;

    // Discord Verification Security

    public static DiscordVerificationRequiredEvent = 4094;

    public static HaircutStylesOfferEvent = 4095;
    public static NameIconEquippedEvent = 4096;
    public static CombatPopupEvent = 4097;
