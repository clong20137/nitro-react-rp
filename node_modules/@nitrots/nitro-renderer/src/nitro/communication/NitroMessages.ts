...
export class NitroMessages implements IMessageConfiguration {
    ...
    private registerEvents(): void {
        // ROLEPLAY\\
        this._events.set(IncomingHeader.ArenaStatusMessageEvent, ArenaStatusMessageEvent);
        this._events.set(IncomingHeader.CommandsListEvent, CommandsListMessageEvent);
        this._events.set(IncomingHeader.BulkAddFloorItemsEvent, BulkAddFloorItemsEvent);
        ...
        this._events.set(IncomingHeader.TokenPurchaseOkEvent, TokenPurchaseOkEvent);
        this._events.set(IncomingHeader.PoliceCallEvent, PoliceCallEvent);
        this._events.set(IncomingHeader.ClickThroughStateEvent, ClickThroughStateEvent);
        this._events.set(IncomingHeader.OpponentStatsEvent, OpponentStatsEvent);
        this._events.set(IncomingHeader.OpenFishingModuleEvent, OpenFishingModuleMessageEvent);
        this._events.set(IncomingHeader.NameIconPurchaseEvent, NameIconPurchaseOkEvent);
        this._events.set(IncomingHeader.NameIconShopEvent, NameIconShopEvent);
        this._events.set(IncomingHeader.ChatBubblePurchaseOkEvent, ChatBubblePurchaseOkEvent);
        this._events.set(IncomingHeader.ChatBubbleShopEvent, ChatBubbleShopEvent);
        ...
        this._events.set(IncomingHeader.TurfCaptureProgressEvent, TurfCaptureProgressEvent);
        ...
        this._events.set(IncomingHeader.SlotMachineStateEvent, SlotMachineStateEvent);
        this._events.set(IncomingHeader.SlotMachineModuleEvent, SlotMachineModuleEvent);
        this._events.set(IncomingHeader.MarketPlaceEvent, MarketplaceModuleEvent);
        this._events.set(IncomingHeader.BlackjackModuleEvent, BlackjackModuleEvent);
        this._events.set(IncomingHeader.BlackjackStateEvent, BlackjackStateEvent);
        this._events.set(IncomingHeader.CorporationRanksEvent, CorporationRanksEvent);
        this._events.set(IncomingHeader.GetCorporationMembersEvent, CorporationMembersEvent);
        this._events.set(IncomingHeader.HighLowModuleComposer, HighLowModuleEvent);
        this._events.set(IncomingHeader.HighLowStateComposer, HighLowStateEvent);
        this._events.set(IncomingHeader.HeightMapUpdateEvent, HeightMapUpdateEvent);
        
        this._events.set(IncomingHeader.ColorPalette, PaletteHexesEvent);
        this._events.set(IncomingHeader.InventoryUpdateEvent, EquippedLoadoutEvent);
        this._events.set(IncomingHeader.GetCorporationsEvent, CorporationsListEvent);
        this._events.set(IncomingHeader.VirtualRoomInfoEvent, VirtualRoomInfoEvent);
        this._events.set(IncomingHeader.WantedList, WantedListEvent);
        this._events.set(IncomingHeader.UpdateWorkStatus, UpdateWorkStatusEvent);
        this._events.set(IncomingHeader.GangRanksEvent, GangRanksEvent);
        this._events.set(IncomingHeader.GangInvitePopupComposer, GangInviteEvent);
        this._events.set(IncomingHeader.ItemOfferPopupComposer, ItemOfferPopupEvent);
        this._events.set(IncomingHeader.CancelGatherComposer, CancelGatherEvent);
        this._events.set(IncomingHeader.OpenSellModuleEvent, OpenSellModuleEvent);
        this._events.set(IncomingHeader.GatherProgressComposer, GatherProgressEvent);
        ...
        this._events.set(IncomingHeader.BulkRemoveFloorItemsEvent, BulkFurnitureFloorRemoveEvent);
    ...
    private registerComposers(): void {
        // ROLEPLAY
        this._composers.set(OutgoingHeader.ArenaLeaveQueueComposer, ArenaLeaveQueueComposer);
        this._composers.set(OutgoingHeader.ArenaJoinQueueComposer, ArenaJoinQueueComposer);
        this._composers.set(OutgoingHeader.ATMWithdrawComposer, ATMWithdrawComposer);
        this._composers.set(OutgoingHeader.ATMDepositComposer, ATMDepositComposer);
        this._composers.set(OutgoingHeader.RequestTokenStoreComposer, RequestTokenStoreComposer);
        this._composers.set(OutgoingHeader.PurchaseTokenComposer, PurchaseTokenComposer);
        this._composers.set(OutgoingHeader.AcceptPoliceCallComposer, AcceptPoliceCallComposer);
        this._composers.set(OutgoingHeader.ReportPoliceCallComposer, ReportPoliceCallComposer);
        this._composers.set(OutgoingHeader.StartInspectComposer, StartInspectComposer);
        this._composers.set(OutgoingHeader.ChangeNameIconComposer, ChangeNameIconComposer);
        this._composers.set(OutgoingHeader.PurchaseNameIconComposer, PurchaseNameIconComposer);
        this._composers.set(OutgoingHeader.RequestNameIconStoreComposer, RequestNameIconStoreComposer);
        this._composers.set(OutgoingHeader.PurchaseChatBubbleComposer, PurchaseChatBubbleComposer);
        this._composers.set(OutgoingHeader.RequestChatBubbleComposer, RequestChatBubbleStoreComposer);
        this._composers.set(OutgoingHeader.ChangeChatBubbleComposer, ChangeChatBubbleComposer);

        // Taxi
        this._composers.set(OutgoingHeader.TaxiRequestComposer, TaxiRequestComposer);

        // Turfs
        this._composers.set(OutgoingHeader.StartTurfCapture, StartTurfCaptureComposer);
        

        // Right Side View

        this._composers.set(OutgoingHeader.ChangeRoomName, RenameVirtualRoomComposer);

        //this._composers.set(OutgoingHeader.EditRoomTileComposer, EditRoomTileMessageComposer);
        // HIGH LOW

        this._composers.set(OutgoingHeader.HighLowDeclineComposer, HighLowDeclineComposer);
        this._composers.set(OutgoingHeader.HighLowAcceptComposer, HighLowAcceptComposer);
        this._composers.set(OutgoingHeader.HighLowStartComposer, HighLowStartComposer);
        this._composers.set(OutgoingHeader.HighLowGuessComposer, HighLowGuessComposer);
        this._composers.set(OutgoingHeader.HighLowLeaveComposer, HighLowLeaveComposer);

        // BLACKJACK

        this._composers.set(OutgoingHeader.BlackjackAcceptComposer, BlackjackAcceptComposer);
        this._composers.set(OutgoingHeader.BlackjackDeclineComposer, BlackjackDealComposer);
        this._composers.set(OutgoingHeader.BlackjackDoubleComposer, BlackjackDoubleComposer);
        this._composers.set(OutgoingHeader.BlackjackHitComposer, BlackjackHitComposer);
        this._composers.set(OutgoingHeader.BlackjackInsuranceComposer, BlackjackInsuranceComposer);
        this._composers.set(OutgoingHeader.BlackjackLeaveComposer, BlackjackLeaveComposer);
        this._composers.set(OutgoingHeader.BlackjackStandComposer, BlackjackStandComposer);
        
        

        this._composers.set(OutgoingHeader.LockTargetComposer, SetTargetComposer);
        this._composers.set(OutgoingHeader.EmsCallDecisionComposer, EmsCallDecisionComposer);
        this._composers.set(OutgoingHeader.EditGangComposer, EditGangComposer);

        this._composers.set(OutgoingHeader.FireCorporationMemberComposer, FireCorporationMemberComposer);
        this._composers.set(OutgoingHeader.DemoteCorporationMemberComposer, DemoteCorporationMemberComposer);
        this._composers.set(OutgoingHeader.PromoteCorporationMemberComposer, PromoteCorporationMemberComposer);
        this._composers.set(OutgoingHeader.HireCorporationMember, HireCorporationMemberComposer);
        this._composers.set(OutgoingHeader.GetCorporationRanksComposer, GetCorporationRanksComposer);
        this._composers.set(OutgoingHeader.GetCorporationMembersComposer, GetCorporationMembersComposer);
        this._composers.set(OutgoingHeader.ColorPallete, GetPartPaletteHexesComposer);
        this._composers.set(OutgoingHeader.GetCorporationList, GetCorporationsComposer);
        this._composers.set(OutgoingHeader.GetWantedList, GetWantedListComposer);
        this._composers.set(OutgoingHeader.ToggleGangChat, ToggleGangChatComposer);
        ...
        this._composers.set(OutgoingHeader.GangDelete, DeleteGangMessageComposer);
        this._composers.set(OutgoingHeader.GangResponse, GangInviteResponseComposer);
        this._composers.set(OutgoingHeader.GangInvite, GangInviteComposer);
        this._composers.set(OutgoingHeader.ResponseComposer, AcceptItemOfferComposer);
        this._composers.set(OutgoingHeader.PassiveModeComposer, PassiveModeComposer);
        this._composers.set(OutgoingHeader.SellItemComposer, SellItemComposer);
        this._composers.set(OutgoingHeader.CallPoliceComposer, CallPoliceComposer);
        this._composers.set(OutgoingHeader.SlotMachineLeaveComposer, SlotMachineLeaveComposer);
        ...
        this._composers.set(OutgoingHeader.GANG_STATUS, CheckGangStatusComposer);
        // AUTHENTICATION
        this._composers.set(
