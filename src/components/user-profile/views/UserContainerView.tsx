        ...
        <Flex gap={2}>
            ...
            <Column>
                <Column gap={0}>
                    ...
                    <Text italics textBreak small>
                        {userProfile.motto}&nbsp;
                    </Text>
                </Column>
                <Column gap={1}>
                    <Text small>
                        <b>{LocalizeText("extendedprofile.created")}</b>{" "}
                        {userProfile.registration}
                    </Text>
                    <Text small>
                        <b>{LocalizeText("extendedprofile.last.login")}</b>{" "}
                        {FriendlyTime.format(
                ...
                <Flex gap={1}>
                    ...
                    <Flex alignItems="center" gap={1}>
                        {canSendFriendRequest && (
                            <Text small underline pointer onClick={addFriend}>
